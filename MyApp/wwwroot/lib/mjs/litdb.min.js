...
${a}${r??"JOIN"} `+i+n+s}return t}into(e){var{sql:t,params:r}=this.build();return{sql:t,params:r,into:e}}build(){return{sql:this.buildWhere(),params:sortParams(this.params)}}toString(e){var t=this.build();if("debug"!=e&&"verbose"!=e)return Inspect.dump(t);var r=t.into,r=r&&(r.name||r.$type&&r.$type.name||r.constructor.name)||"",t=[Inspect.dump(t).trim(),[this[type]??"",r&&"["!=r[0]?" => "+r:""].join(""),""].join("\n");if("verbose"!==e)return t;var s,n,i={refs:this.refs.map(e=>e.$ref).map(e=>[Meta.assert(e.cls).tableName,e.as!=this.quote(Meta.assert(e.cls).tableName)?e.as:""].filter(e=>!!e).join(" "))};for([s,n]of Object.entries(this))"_"==s[0]&&IS.arr(n)&&n.length&&(i[s.substring(1)]=n);return[t.trimEnd(),Inspect.dump(i).replaceAll('"',""),""].join("\n")}}class SelectQuery extends WhereQuery{get[type](){return clsName("SelectQuery",...this.tables)}_select=[];_groupBy=[];_having=[];_orderBy=[];_skip;_take;_limit;copyInto(e){return super.copyInto(e),e._select=Array.from(this._select),e._groupBy=Array.from(this._groupBy),e._having=Array.from(this._having),e._skip=this._skip,e._take=this._take,e}clone(){return super.clone()}groupBy(e,...t){if(e||0!=t.length)if(Array.isArray(e)){t=this.$(e,...t);this._groupBy.push(this.mergeParams(t))}else if(IS.fn(e)){t=assertSql(e.call(this,...this.refs));this._groupBy.push(this.mergeParams(t))}else{if(!IS.rec(e))throw EX.arg(e);t=IS.fn(e.build)?e.build(this.refs):assertSql(e);this._groupBy.push(this.mergeParams(t))}else this._groupBy.length=0;return this}having(e,...t){if(e||0!=t.length)if(Array.isArray(e)){t=this.$(e,...t);this._having.push(this.mergeParams(t))}else if(IS.fn(e)){t=assertSql(e.call(this,...this.refs));this._having.push(this.mergeParams(t))}else{if(!IS.rec(e))throw EX.arg(e);t=IS.fn(e.build)?e.build(this.refs):assertSql(e);this._having.push(this.mergeParams(t))}else this._having.length=0;return this}orderBy(e,...t){if(e||0!=t.length)if(IS.arr(e)){t=this.$(e,...t);this._orderBy.push(this.mergeParams(t))}else if(IS.fn(e)){t=assertSql(e.call(this,...this.refs));this._orderBy.push(this.mergeParams(t))}else{if(!IS.rec(e))throw EX.arg(e);t=IS.fn(e.build)?e.build(this.refs):assertSql(e);this._orderBy.push(this.mergeParams(t))}else this._orderBy.length=0;return this}select(e,...r){if(e||0!==r.length)if(IS.str(e))this._select.push(e),1<=r.length&&this.addParams(r[0]);else if(Array.isArray(e))this._select.push(this.mergeParams(this.$(e,...r)));else if(IS.fn(e)){r=assertSql(e.call(this,...this.refs));this._select.push(this.mergeParams(r))}else{if(!IS.rec(e))throw new Error(`Invalid select(${typeof e})`);r=e;if(r.props)for(let t of r.props){var s=this.meta.props.find(e=>e.name==t)?.column;s&&this._select.push(this.quoteColumn(s))}if(r.columns)for(var t of r.columns)this._select.push(this.quoteColumn(t))}else this._select.length=0;return this}get hasSelect(){return 0<this._select.length}skip(e){return this.limit(this._take,e)}take(e){return this.limit(e,this._skip)}limit(e,t){return this._take=null==e?void 0:e,this._skip=null==t?void 0:t,"limit"in this.params&&delete this.params.limit,"offset"in this.params&&delete this.params.offset,null==e&&null==t?this._limit=void 0:(e=this.$.dialect.sqlLimit(this._skip,this._take),this._limit=this.mergeParams(e)),this}exists(){var e=this.clone();return e._select=["TRUE"],e._limit="LIMIT 1",e.into(Boolean)}rowCount(){var{sql:e,params:t}=this.build();return{sql:this.$.schema.sqlRowCount(e),params:t,into:Number}}buildSelect(){return"SELECT "+(0<this._select.length?this._select:this.meta.columns.map(e=>this.quoteColumn(e))).join(", ")}buildFrom(){var e=this.quoteTable(this.meta.tableName);let t=`
 ...
 `+this._limit:""}build(){return{sql:this.buildSelect()+this.buildFrom()+this.buildJoins()+this.buildWhere()+this.buildGroupBy()+this.buildHaving()+this.buildOrderBy()+this.buildLimit(),params:sortParams(this.params),into:0==this._select.length?this.tables[0]:void 0}}}class UpdateQuery extends WhereQuery{get name(){return clsName("UpdateQuery",...this.tables)}_set=[];set(r,...e){if(r||(this._set.length=0),IS.tpl(r)){e=this.$(r,...e);this._set.push(this.mergeParams(e))}else if(IS.fn(r)){e=assertSql(r.call(this,...this.refs));this._set.push(this.mergeParams(e))}else{if(!IS.rec(r))throw EX.arg(r);if("sql"in r)this._set.push(this.mergeParams(r));else for(let[t,e]of Object.entries(r)){var s=this.meta.props.find(e=>e.name===t);if(!s)throw new Error(`Property ${t} not found in `+this.meta.name);if(!s.column)throw new Error(`Property ${t} is not a column`);this.params[s.name]=e,this._set.push(this.$.quote(s.column.name)+" = $"+s.name)}}return this}get hasSet(){return 0<this._set.length}buildUpdate(){var e=this._set.join(", ");return`UPDATE ${this.quoteTable(this.meta.tableName)} SET `+e+this.buildWhere()}build(){return{sql:this.buildUpdate(),params:this.params}}}class DeleteQuery extends WhereQuery{get[type](){return clsName("DeleteQuery",...this.tables)}buildDelete(){return"DELETE FROM "+this.quoteTable(this.meta.tableName)+this.buildWhere()}build(){return{sql:this.buildDelete(),params:this.params}}}class Sql{static ops={equals:"=","=":"=",notEquals:"<>","!=":"!=",like:"LIKE",startsWith:"LIKE",endsWith:"LIKE",contains:"LIKE",notLike:"NOT LIKE",in:"IN",notIn:"NOT IN",isNull:"IS NULL",notNull:"IS NOT NULL"};static opKeys=Object.keys(Sql.ops);static create(m){function s(t,...s){if(IS.tpl(t)){let r="";var n={};for(let e=0;e<t.length;e++)if(r+=t[e],!(e>=s.length)){var i,a=s[e];if(IS.sym(a))r+=a.description??"";else if(IS.arr(a)){let e="";for(var o of a){var l="_"+(Object.keys(n).length+1);e.length&&(e+=","),e+="$"+l,n[l]=o}r+=e}else if(IS.rec(a)&&a.$ref)r+=m.quoteTable(Meta.assert(a.$ref.cls).tableName);else if(IS.obj(a)&&IS.fn(a.build)){var u,c=a.build();let t=["limit","offset"];if(Object.keys(c.params).some(e=>t.includes(e)))for(var h of t)h in c.params&&(u="_"+nextParamVal(c.params),c.params[u]=c.params[h],delete c.params[h],c.sql=c.sql.replaceAll("$"+h,"$"+u));r+=mergeParams(n,c).replaceAll("\n","\n      ")}else IS.obj(a)&&IS.str(a.sql)?r+=mergeParams(n,a).replaceAll("\n","\n      "):a&&(i="_"+(Object.keys(n).length+1),r+="$"+i,n[i]=a)}return{sql:r,params:n}}if(IS.str(t))return{sql:t,params:s[0]};throw new Error(`sql(${typeof t}) is invalid`)}return s.schema=DriverRequiredProxy,s.dialect=m,s.quote=m.quote.bind(m),s.quoteColumn=m.quoteColumn.bind(m),s.quoteTable=m.quoteTable.bind(m),s.ref=function(r,s){let n=Meta.assert(r);null==s&&(s=m.quoteTable(n.tableName));return new Proxy({prefix:s?s+".":"",meta:n},{get:(e,t)=>"$ref"==t?{cls:r,as:s}:Symbol(e.prefix+((e,t)=>{var r=e.props.find(e=>e.name==t)?.column;if(r)return m.quoteColumn(r);throw new Error(e.name+" does not have a column property "+t)})(n,IS.str(t)?t:t.description))})},s.refs=function(...e){return e.map(e=>s.ref(e))},s.sql=function(e,t={}){return IS.rec(e)?{sql:mergeParams(t,e),params:t}:{sql:e,params:t}},s.from=function(e,t){var r=asType(e),e=asRef(e)??s.ref(e,t??"");return new SelectQuery(s,[r],[Meta.assert(r)],[e])},s.update=function(e){return new UpdateQuery(s,[e],[Meta.assert(e)],[s.ref(e,"")])},s.deleteFrom=function(e){return new DeleteQuery(s,[e],[Meta.assert(e)],[s.ref(e,"")])},s.join=function(...e){return new SqlJoinBuilder(s,...e)},s.groupBy=function(...e){return new SqlGroupByBuilder(s,...e)},s.having=function(...e){return new SqlHavingBuilder(s,...e)},s.orderBy=function(...e){return new SqlOrderByBuilder(s,...e)},s.idEquals=function(t){return e=>s.sql(s`${e.id} = $id`,{id:t})},s.log=function(e){console.log(Inspect.dump(e))},s.dump=function(e){console.log(Inspect.dumpTable(e))},s}}class SqlJoinBuilder{$;get table(){return this.tables[0]}tables;refs;exprs=[];params={};alias="";buildOn;constructor(e,...t){this.$=e,this.tables=t,this.refs=this.tables.map(e=>this.$.ref(e))}join(e,...t){return this.add("JOIN",e,...t)}leftJoin(e,...t){return this.add("LEFT JOIN",e,...t)}rightJoin(e,...t){return this.add("RIGHT JOIN",e,...t)}fullJoin(e,...t){return this.add("FULL JOIN",e,...t)}crossJoin(e,...t){return this.add("CROSS JOIN",e,...t)}add(e,t,...r){return Array.isArray(t)?this.exprs.push({type:e,expr:e=>this.$(t,...r)}):"function"==typeof t&&this.exprs.push({type:e,expr:e=>t.call(this,...e)}),this}as(e){return this.alias=e,this}build(e){this.alias&&(e[0]=this.$.ref(e[0].$ref.cls,this.alias));var t,r={},s=[];for(t of this.exprs){var n=t.expr(e),i=s.length?""+alignRight(t.type,5):"";s.push(i+" "+mergeParams(r,n))}var a=s.join("");return{type:this.exprs[0].type,on:a,params:r}}}class SqlBuilderBase{$;tables;params={};exprs=[];delimiter=", ";constructor(e,...t){this.$=e,this.tables=t}add(t,...r){return Array.isArray(t)?this.exprs.push(e=>this.$(t,...r)):"function"==typeof t&&this.exprs.push(e=>t.call(this,...e)),this}build(e){var t,r={},s=[],n=[];for(let t of this.tables){var i=e.find(e=>e.$ref.cls===t)??this.$.ref(t);n.push(i)}for(t of this.exprs){var a=t(n);s.push(mergeParams(r,a))}return{sql:s.join(this.delimiter),params:r}}}class SqlGroupByBuilder extends SqlBuilderBase{}class SqlOrderByBuilder extends SqlBuilderBase{}class SqlHavingBuilder extends SqlBuilderBase{constructor(e,...t){super(e,...t),this.delimiter="\n  AND "}}class DbConnection{connection;driver;$;schema;constructor(e){this.connection=e,this.$=e.$,this.driver=e.driver,this.schema=this.$.schema=e.driver.schema}get sync(){if(null==this.driver.sync)throw new Error(this.$.name+" does not support sync APIs");return this.driver.sync}quote(e){return this.$.quote(e)}insert(e,t){return Promise.resolve(this.sync.insert(e,t))}insertAll(e,t){return Promise.resolve(this.sync.insertAll(e,t))}update(e,t){return Promise.resolve(this.sync.update(e,t))}delete(e,t){return Promise.resolve(this.sync.delete(e,t))}listTables(){return Promise.resolve(this.sync.listTables())}dropTable(e){return Promise.resolve(this.sync.dropTable(e))}createTable(e){return Promise.resolve(this.sync.createTable(e))}all(e,...t){return Promise.resolve(this.sync.all(e,...t))}one(e,...t){return Promise.resolve(this.sync.one(e,...t))}column(e,...t){return Promise.resolve(this.sync.column(e,...t))}value(e,...t){return Promise.resolve(this.sync.value(e,...t))}arrays(e,...t){return Promise.resolve(this.sync.arrays(e,...t))}array(e,...t){return Promise.resolve(this.sync.array(e,...t))}exec(e,...t){return Promise.resolve(this.sync.exec(e,...t))}run(e,...t){return Promise.resolve(this.sync.run(e,...t))}prepare(e,...t){var r,s=this.connection;if(IS.tpl(e))return[s.prepare(e,...t),t,void 0];if(IS.obj(e)){if("build"in e)return t=e.build(),[s.prepare(t.sql),t.params??{},t.into];if("sql"in e)return t=e.sql,r=e.params??{},[s.prepare(t),r,e.into]}throw new Error("Invalid argument: "+toStr(e))}close(){return this.connection.close()}}class SyncDbConnection{connection;driver;$;schema;constructor(e){this.connection=e,this.$=e.$,this.driver=e.driver,this.schema=this.$.schema=e.driver.schema}quote(e){return this.$.quote(e)}insert(e,t){var r,s,n;return e?(r=e.constructor,s=this.schema,t?.onlyProps||t?.onlyWithValues?(t={onlyProps:t?.onlyProps??propsWithValues(e)},n=this.connection.prepareSync(s.insert(r,t)),t=s.toDbObject(e,t),n.execSync(t)):(n=this.connection.prepareSync(s.insert(r)),t=s.toDbObject(e),n.execSync(t))):{changes:0,lastInsertRowid:0}}insertAll(e,t){var r={changes:0,lastInsertRowid:0};if(0!=e.length){var s=e[0].constructor;if(t?.onlyProps||t?.onlyWithValues)for(var n of e){n=this.insert(n,t);r.changes+=n.changes,r.lastInsertRowid=n.lastInsertRowid}else{var i,a=this.connection.prepareSync(this.schema.insert(s));for(i of e){var o=this.schema.toDbObject(i),o=a.execSync(o);r.changes+=o.changes,r.lastInsertRowid=o.lastInsertRowid}}}return r}update(e,t){var r,s,n;return e?(r=e.constructor,s=this.schema,t?.onlyProps||t?.onlyWithValues?(n=r.$props.filter(e=>e.column?.primaryKey).map(e=>e.column.name),t={onlyProps:Array.from(new Set([...t?.onlyProps??propsWithValues(e),...n]))},n=this.connection.prepareSync(s.update(r,t)),t=s.toDbObject(e,t),n.execSync(t)):(n=this.connection.prepareSync(s.update(r)),t=s.toDbObject(e),n.execSync(t))):{changes:0,lastInsertRowid:0}}delete(e,t){var r;return e?(r=e.constructor,t=this.connection.prepareSync(this.schema.delete(r,t)),r=Meta.assert(r).props.filter(e=>e.column?.primaryKey).map(e=>e.name),e=this.schema.toDbObject(e,{onlyProps:r}),t.execSync(e)):{changes:0,lastInsertRowid:0}}listTables(){return this.column({sql:this.schema.sqlTableNames(),params:{}})}dropTable(e){this.connection.prepareSync(this.schema.dropTable(e)).runSync()}createTable(e){this.connection.prepareSync(this.schema.createTable(e)).runSync()}prepareSync(e,...t){var r,s=this.connection;if(IS.tpl(e))return[s.prepareSync(e,...t),t,void 0];if(IS.obj(e)){if("build"in e)return t=e.build(),[s.prepareSync(t.sql),t.params??{},t.into];if("sql"in e)return t=e.sql,r=e.params??{},[s.prepareSync(t),r,e.into]}throw new Error("Invalid argument: "+toStr(e))}all(e,...t){var[e,t,r]=this.prepareSync(e,...t);return r?(r=e.as(r),IS.arr(t)?r.allSync(...t):r.allSync(t)):IS.arr(t)?e.allSync(...t):e.allSync(t)}one(e,...t){var[e,t,r]=this.prepareSync(e,...t);return r?(r=e.as(r),IS.arr(t)?r.oneSync(...t):r.oneSync(t)):IS.arr(t)?e.oneSync(...t):e.oneSync(t)}column(e,...t){var[e,t]=this.prepareSync(e,...t);return IS.arr(t)?e.arraysSync(...t).map(e=>e[0]):e.arraysSync(t).map(e=>e[0])}value(e,...t){var[e,t,r]=this.prepareSync(e,...t),e=IS.arr(t)?e.valueSync(...t):e.valueSync(t);return r&&r===Boolean?!!e:e}arrays(e,...t){var[e,t]=this.prepareSync(e,...t);return IS.arr(t)?e.arraysSync(...t):e.arraysSync(t)}array(e,...t){var[e,t]=this.prepareSync(e,...t);return IS.arr(t)?e.arraySync(...t):e.arraySync(t)}exec(e,...t){var[e,t]=this.prepareSync(e,...t);return IS.arr(t)?e.execSync(...t):e.execSync(t)}run(e,...t){var[e,t]=this.prepareSync(e,...t);IS.arr(t)?e.runSync(...t):e.runSync(t)}close(){this.connection.closeSync()}}class ConnectionBase{driver;$;async;sync;schema;dialect;constructor(e){this.driver=e,this.$=e.$,this.schema=this.$.schema=e.schema,this.dialect=e.dialect,this.async=new DbConnection(this),this.sync=new SyncDbConnection(this)}prepare(e){throw new Error(DriverRequired)}prepareSync(e){throw new Error(DriverRequired)}close(){throw new Error(DriverRequired)}closeSync(){throw new Error(DriverRequired)}}class DefaultStrategy{tableName(e){return e}columnName(e){return e}}class SnakeCaseStrategy{tableName(e){return snakeCase(e)}columnName(e){return snakeCase(e)}}class DialectBase{$;strategy=new DefaultStrategy;constructor(){this.$=Sql.create(this)}quote(e){return isQuoted(e)?e:`"${e}"`}quoteTable(e){return IS.str(e)?isQuoted(e)?e:this.quote(this.strategy.tableName(e)):this.quote(e.alias??this.strategy.tableName(e.name))}quoteColumn(e){return IS.str(e)?isQuoted(e)?e:this.quote(this.strategy.columnName(e)):this.quote(e.alias??this.strategy.columnName(e.name))}sqlLimit(e,t){if(null==e&&null==t)throw new Error(`Invalid argument sqlLimit(${e}, ${t})`);return e?this.$.sql("LIMIT $limit OFFSET $offset",{offset:e,limit:t??-1}):this.$.sql("LIMIT $limit",{limit:t})}}class SyncFilterConn{db;fn;$;orig;constructor(e,t){this.db=e,this.fn=t,this.orig=e.connection,(e.connection=this).$=e.$}get driver(){return this.db.driver}prepareSync(e,...t){return this.fn(e,t),this.orig.prepareSync(e,...t)}release(){this.db.connection=this.orig}closeSync(){this.db.connection.closeSync()}}function useFilterSync(e,t){return new SyncFilterConn(e,t)}class FilterConn{db;fn;$;orig;constructor(e,t){this.db=e,this.fn=t,this.orig=e.connection,(e.connection=this).$=e.$}get driver(){return this.db.driver}prepare(e,...t){return this.fn(e,t),this.orig.prepare(e,...t)}release(){this.db.connection=this.orig}close(){return this.db.connection.close()}}function useFilter(e,t){return new FilterConn(e,t)}class SqliteDialect extends DialectBase{}class SqliteSchema extends Schema{sqlTableNames(){return"SELECT name FROM sqlite_master WHERE type ='table' AND name NOT LIKE 'sqlite_%'"}}class SqliteTypes{native=["INTEGER","SMALLINT","BIGINT","REAL","DOUBLE","FLOAT","NUMERIC","DECIMAL","BOOLEAN","DATE","DATETIME"];map={INTEGER:["INTERVAL","MONEY"],BLOB:["BLOB","BYTES","BIT"],TEXT:["UUID","JSON","JSONB","XML","TIME","TIMEZ","TIMESTAMP","TIMESTAMPZ"]}}class Sqlite{static connection;static driver;static schema;static init(){var e=Sqlite.connection=new SqliteConnection(new Sqlite),{driver:t,schema:r}=e;return Object.assign(Sqlite,{driver:t,schema:r}),e}name;dialect;schema;strategy=new DefaultStrategy;$;constructor(){this.name=this.constructor.name,this.dialect=new SqliteDialect,this.$=this.dialect.$,this.schema=this.$.schema=new SqliteSchema(this,this.$,new SqliteTypes)}}class SqliteConnection extends ConnectionBase{}class MySqlDialect extends DialectBase{quote(e){return isQuoted(e)?e:"`"+e+"`"}sqlLimit(e,t){if(null==e&&null==t)throw new Error(`Invalid argument sqlLimit(${e}, ${t})`);return e?t?this.$.sql("LIMIT $offset, $limit",{offset:e,limit:t}):this.$.sql("LIMIT $offset, 18446744073709551615",{offset:e}):this.$.sql("LIMIT $limit",{limit:t})}}class DateConverter{toDb(e){e=toDate(e);return e?dateISOString(e).replace("T"," "):null}fromDb(e){return e?toDate(e):null}}class MySqlSchema extends Schema{constructor(e,t,r){super(e,t,r),Object.assign(this.converters,converterFor(new DateConverter,"DATE","DATETIME","TIMESTAMP","TIMESTAMPZ"))}sqlIndexDefinition(e,t){var r=t.unique?"UNIQUE INDEX":"INDEX",s=(`idx_${e.name}_`+t.name).toLowerCase(),n=t.type.endsWith("TEXT")?"(255)":"";return`CREATE ${r} ${s} ON ${this.quoteTable(e)} (${this.quoteColumn(t)}${n})`}sqlColumnDefinition(e){var t=this.dataType(e);let r=this.quoteColumn(e)+" "+t;return e.primaryKey&&(r+=" PRIMARY KEY"),e.autoIncrement&&(r+=" AUTO_INCREMENT"),e.required&&(r+=" NOT NULL"),e.unique&&!e.index&&(r+=" UNIQUE"),r+=this.defaultValue(e)}sqlTableNames(){return super.sqlTableNames()+" AND table_schema = DATABASE()"}}class MySqlTypes{native=["INTEGER","SMALLINT","BIGINT","DOUBLE","FLOAT","DECIMAL","NUMERIC","DECIMAL","BOOLEAN","DATE","DATETIME","TIME","TIMESTAMP","UUID","JSON","XML","BLOB"];map={DOUBLE:["REAL"],TIME:["TIMEZ"],TIMESTAMP:["TIMESTAMPZ"],INTEGER:["INTERVAL"],JSON:["JSONB"],TEXT:["XML"],BINARY:["BYTES"],"BINARY(1)":["BIT"],"DECIMAL(15,2)":["MONEY"]}}class MySql extends Sqlite{static connection;static driver;static schema;static init(){var e=MySql.connection=new MySqlConnection(new MySql),{driver:t,schema:r}=e;return Object.assign(MySql,{driver:t,schema:r}),e}constructor(){super(),this.dialect=new MySqlDialect,this.$=this.dialect.$,this.schema=this.$.schema=new MySqlSchema(this,this.$,new MySqlTypes)}}class MySqlConnection extends ConnectionBase{}class PostgreSqlDialect extends DialectBase{sqlLimit(e,t){if(null==e&&null==t)throw new Error(`Invalid argument sqlLimit(${e}, ${t})`);return e?t?this.$.sql("LIMIT $limit OFFSET $offset",{offset:e,limit:t}):this.$.sql("OFFSET $offset",{offset:e}):this.$.sql("LIMIT $limit",{limit:t})}}class PostgreSqlSchema extends Schema{sqlColumnDefinition(e){let t=this.dataType(e),r=(e.autoIncrement&&(t="BIGINT"==t?"BIGSERIAL":"SERIAL"),this.quoteColumn(e)+" "+t);return e.primaryKey&&(r+=" PRIMARY KEY"),e.required&&(r+=" NOT NULL"),e.unique&&!e.index&&(r+=" UNIQUE"),r+=this.defaultValue(e)}sqlRowCount(e){return`SELECT COUNT(*)::int FROM (${e}) AS COUNT`}}class PostgreSqlTypes{native=["INTEGER","SMALLINT","BIGINT","REAL","DOUBLE","FLOAT","DECIMAL","NUMERIC","DECIMAL","MONEY","BOOLEAN","DATE","TIME","TIMEZ","TIMESTAMP","TIMESTAMPZ","INTERVAL","UUID","JSON","JSONB","XML","BLOB","BYTES","BIT"];map={TIMESTAMPTZ:["DATETIME"]}}class PostgreSql extends Sqlite{static connection;static driver;static schema;static init(){var e=PostgreSql.connection=new PostgreSqlConnection(new PostgreSql),{driver:t,schema:r}=e;return Object.assign(PostgreSql,{driver:t,schema:r}),e}constructor(){super(),this.dialect=new PostgreSqlDialect,this.$=this.dialect.$,this.schema=this.$.schema=new PostgreSqlSchema(this,this.$,new PostgreSqlTypes)}}class PostgreSqlConnection extends ConnectionBase{}var sqlite=Sqlite.init().$,mysql=MySql.init().$,postgres=PostgreSql.init().$;export{useFilterSync,useFilter,uniqueKeys,toStr,toDate,table,sqlite,sortParams,snakeCase,postgres,pick,pad,omit,nextParamVal,nextParam,mysql,mergeParams,dateISOString,converterFor,column,asType,asRef,WhereQuery,Watch,UpdateQuery,Table,SyncDbConnection,SqliteTypes,SqliteSchema,SqliteDialect,Sqlite,Sql,SnakeCaseStrategy,SelectQuery,Schema,PostgreSqlTypes,PostgreSqlSchema,PostgreSqlDialect,PostgreSql,MySqlTypes,MySqlSchema,MySqlDialect,MySql,Meta,Inspect,IS,DeleteQuery,DefaultValues,DefaultStrategy,DbConnection,DateTimeConverter,ConnectionBase};